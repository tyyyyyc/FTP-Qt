#############################################################################
# Makefile for building: FTP
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sat Sep 7 10:52:21 2019
# Project:  FTP.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile FTP.pro
#############################################################################
...
Makefile: FTP.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile FTP.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/FTP1.0.0 || $(MKDIR) .tmp/FTP1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/FTP1.0.0/ && $(COPY_FILE) --parents widget.h .tmp/FTP1.0.0/ && $(COPY_FILE) --parents main.cpp widget.cpp .tmp/FTP1.0.0/ && $(COPY_FILE) --parents widget.ui .tmp/FTP1.0.0/ && (cd `dirname .tmp/FTP1.0.0` && $(TAR) FTP1.0.0.tar FTP1.0.0 && $(COMPRESS) FTP1.0.0.tar) && $(MOVE) `dirname .tmp/FTP1.0.0`/FTP1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/FTP1.0.0
